...
import { saveIndexValue, triggerRecalculate } from "@/app/indexes/actions"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import IndexUploader from "@/app/indexes/IndexUploader"
import {
...
export default async function PricingIndexesPage() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        ...
        <Link href="/pricing/charts" className="text-sm text-blue-600 hover:underline">
          Historical charts →
        </Link>
      </div>
